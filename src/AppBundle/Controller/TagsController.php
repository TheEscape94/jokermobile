...
class TagsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tags = $em->getRepository('AppBundle:Tags')->findBy(array(), array(
            'id' => 'DESC',
        ));
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_tagovi_new');
        }
    ...
    private function createDeleteForm(Tags $tag)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_tagovi_delete', array('id' => $tag->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
